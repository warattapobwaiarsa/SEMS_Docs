...
- `Design/Database/SEMS_ER_Prisma_Data_Dictionary.md` and workbook-derived Data Dictionary Markdown
- `Design/API/SEMS_API_Specification.md`, `openapi.yaml`, `endpoint-matrix.csv`, error catalog
- Architecture process/state/permission specifications
...
| UAT participant names/dates | Pending Formal Record | Pending Formal Record | Pending Formal Record |
| Production owner, support channel and IT assignees | Pending Formal Record | Pending Formal Record | Pending Formal Record |
| KKU client, claims, domains and infrastructure products | Pending Formal Record | Pending Formal Record | Pending Formal Record |
