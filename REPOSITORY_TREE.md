...
│   │   └── SEMS_ER_Prisma_Data_Dictionary.md [v0.4 Draft]
│   ├── Data_Templates/
│   │   ├── Data_import_to_web.xlsx [v1.0]
│   │   ├── Data_import_to_web_Specification.md [v1.0]
│   │   ├── SEMS_Applicant_Import_Mapping_Specification.md [v0.4 Confirmed Response]
...
│   │   └── SEMS_Data_Dictionary_Import_Mapping_Guide.md [v0.3 Baseline Candidate]
│   ├── UI_UX/
│   │   ├── screens/
